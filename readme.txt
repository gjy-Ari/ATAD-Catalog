...
Usage
==========
Training: Execute train.py to train the model using the datasets provided in the train_val folder. Input parameters require Z-score normalization.

Prediction: Execute predict.py to estimate the geometric albedo and effective diameter of asteroids. Unnormalized data can be used directly for ease of application.
