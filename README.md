# The Asteroid Type, Albedo, and Diameter Catalog (ATAD)
This catalog contains taxonomic types, visible geometric albedo and effective diameter of 188,742 asteroids.

Types are sourced from SsODNet (Berthier et al., 2023) and the AGAI catalog (Ge et al., 2025). These have been unified into six types: A, C, D, S, V, and X (Ge et al., 2024).
Samples with ambiguous types that could not be definitively mapped to this classification system were removed.
...
Type_method: Indicates the spectral or photometric passbands, or whether it was predicted via machine learning;
